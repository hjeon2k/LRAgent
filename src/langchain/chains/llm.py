    ...
    def create_outputs(self, llm_result: LLMResult) -> List[Dict[str, Any]]:
        ...
        result = [
            # Get the text of the top generated string.
            {
                ...
                "latency": generation[0].generation_info['latency'],
                "io_seqlen": llm_result.llm_output["token_usage"],
                "full_generation": generation,
            }
            for generation in llm_result.generations
        ]
        if self.return_final_only:
            result = [{self.output_key: r[self.output_key], "latency": r["latency"], "io_seqlen" : r["io_seqlen"]} for r in result]
        return result
