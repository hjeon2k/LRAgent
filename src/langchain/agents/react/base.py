...
class DocstoreExplorer:
    ...
    def search(self, term: str) -> str:
        ...
        # If there are no single quotes in term, wrap it in single quotes for the search
        search_term = f"'{term}'" if "'" not in term else term
    ...
    def _summary(self) -> str:
        # return "".join(self._paragraphs[:2])
