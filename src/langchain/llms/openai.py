...
class ClearKVCache(EngineAPIResource):
    OBJECT_NAME = "clear_kvcache"
        ...
        while True:
            try:
                return super().create(*args, **kwargs)
                    ...
                    raise util.log_info("Waiting for model to warm up", error=e)
