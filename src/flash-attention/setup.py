...
if not SKIP_CUDA_BUILD and not IS_ROCM:
    ...
    # Add flash_lora_attn_2_cuda extension (independent from flash_attn_2_cuda)
    # Note: Only hdim 32/64/96/128 supported (HEADDIM_SWITCH macro limit)
    # Note: bwd kernels removed (run_mha_bwd commented out in flash_api.cpp)
    ext_modules.append(
        CUDAExtension(
            name="flash_lora_attn_2_cuda",
            sources=[
                "csrc/flash_lora_attn/flash_api.cpp",
                # Forward kernels (hdim 32-128)
                "csrc/flash_lora_attn/src/flash_fwd_hdim32_fp16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim32_bf16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim64_fp16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim64_bf16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim96_fp16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim96_bf16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim128_fp16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim128_bf16_sm80.cu",
                # Forward causal kernels (hdim 32-128)
                "csrc/flash_lora_attn/src/flash_fwd_hdim32_fp16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim32_bf16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim64_fp16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim64_bf16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim96_fp16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim96_bf16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim128_fp16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_hdim128_bf16_causal_sm80.cu",
                # Forward split kernels (hdim 32-128)
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim32_fp16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim32_bf16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim64_fp16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim64_bf16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim96_fp16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim96_bf16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim128_fp16_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim128_bf16_sm80.cu",
                # Forward split causal kernels (hdim 32-128)
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim32_fp16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim32_bf16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim64_fp16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim64_bf16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim96_fp16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim96_bf16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim128_fp16_causal_sm80.cu",
                "csrc/flash_lora_attn/src/flash_fwd_split_hdim128_bf16_causal_sm80.cu",
            ],
            extra_compile_args={
                "cxx": ["-O3", "-std=c++17", "-ftemplate-backtrace-limit=0"],
                "nvcc": append_nvcc_threads(
                    [
                        "-O3",
                        "-std=c++17",
            ...
            include_dirs=[
                Path(this_dir) / "csrc" / "flash_lora_attn",
                Path(this_dir) / "csrc" / "flash_lora_attn" / "src",
                Path(this_dir) / "csrc" / "cutlass" / "include",
            ],
        )
    )
