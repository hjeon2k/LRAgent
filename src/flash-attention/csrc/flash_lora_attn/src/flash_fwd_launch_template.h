...
void run_mha_fwd_splitkv_dispatch(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    constexpr static int kBlockN = Headdim <= 64 ? 256 : (Headdim <= 128 ? 64 : 64);
    // constexpr static int kBlockN = 128;
    // optimized for A6000
    run_flash_splitkv_fwd<Flash_fwd_kernel_traits<Headdim, kBlockM, kBlockN, 4, 8, false, false, T>, Is_causal>(params, stream);
...
void run_mha_fwd_hdim32(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    //     run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 128, 4, 8, false, false, T>, Is_dropout, Is_causal>(params, stream);
    // });
}
...
void run_mha_fwd_hdim64(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    //     } else {
    //         // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, 8, false, false, T>, Is_dropout, Is_causal>(params, stream);
    //         // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, true, T>, Is_dropout, Is_causal>(params, stream);
    //         // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, false, T>, Is_dropout, Is_causal>(params, stream);
    //         run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 128, 4, 8, false, false, T>, Is_dropout, Is_causal>(params, stream);
    //     }
...
void run_mha_fwd_hdim96(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    //     //         run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, 8, false, false, T>, Is_dropout, Is_causal>(params, stream);
    //     //     } else {
    //     //         run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 64, 4, 8, false, false, T>, Is_dropout, Is_causal>(params, stream);
    //     //     }
    //     // } else {
    //     //     run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, 8, false, false, T>, Is_dropout, Is_causal>(params, stream);
    //     // }
...
void run_mha_fwd_hdim160(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    //     if (is_sm8x) {
    //         if constexpr(!Is_causal) {
    //             run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 128, 8, 8, false, false, T>, Is_dropout, Is_causal>(params, stream);
    //         } else {
    //             run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 128, 4, 8, false, false, T>, Is_dropout, Is_causal>(params, stream);
    //         }
    //     } else {
    //         run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 128, 4, 8, false, false, T>, Is_dropout, Is_causal>(params, stream);
    //     }
