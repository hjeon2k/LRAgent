...
def generate_stream(
    ...
    # retrieve past key values
    try:
        past_key_values = model.past_key_values['shared']
    except:
    ...
    input_ids = tokenizer(prompt).input_ids[past_seq_length:]
    ...
    # Clean
    del past_key_values, past_lr_caches, out
    gc.collect()
