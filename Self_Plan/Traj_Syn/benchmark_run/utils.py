...
def parse_result(result):
    ...
    try:
        for i in range(len(result)):
            snippet = result[i]['snippet'] if 'snippet' in result[i] else ""
            if snippet != "":
...
def call_web_search(query, count: int = 5):
    # CX = "04128c041aaa244e1"  # hjeon2k snu
    # API_KEY = "AIzaSyCUl63akWv7IOpua31mIJccc0xiknBeweY"  # hjeon2k snu
    CX = "1521d7b0086f44851"  # hjeon2k
    API_KEY = "AIzaSyCP_02bHdWTIT4qILPYzajpTXVFynw_AT4"  # hjeon2k
    # CX = "4130269fc81ef493e"  # hjeon2k2
    # API_KEY = "AIzaSyC0fFZBRFicDJD3p5S5NT7bbhyfLhXSVHI"  # hjeon2k2
    # CX = "7189e995296af467f"  # vlsi-openai
    # API_KEY = "AIzaSyCnAjBvkOm6FwhUwt6PLGJwIJLT2s7l6-0"  # vlsi-openai
    params = {
            "key": API_KEY,
            "cx": CX,
            "q": query.strip('"').strip("'"),
    ...
    try:
        ...
        return parse_result(response.json()['items'])
    except:
        pass
